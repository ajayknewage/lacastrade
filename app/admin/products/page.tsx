...
//       <div className="grid">
//         <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark max-w-full overflow-x-auto">
...
//               </div>
//               <div className="col-span-1 flex items-center">
//                 <p className="text-sm text-meta-3">{product.sold}</p>
//               </div>
//             </div>
//           ))}
        ...
        <table className="w-full table-auto">
          <thead>
            <tr className="bg-gray-2 text-left dark:bg-meta-4">
              <th className="min-w-[220px] py-4 px-4 font-medium text-black dark:text-white xl:pl-11 flex gap-2 items-center">
                <p className="font-medium">Product</p>
                <SortButton />
              </th>
